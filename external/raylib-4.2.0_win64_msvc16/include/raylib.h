...
RLAPI char *TextCodepointsToUTF8(const int *codepoints, int dataLen);  // Encode text as codepoints array into UTF-8 text string (WARNING: memory must be freed!)
...
RLAPI const char *TextSubtext(const char *text, int position, int dataLen);                  // Get a piece of a text string
...
RLAPI void DrawCube(Vector3 position, float width, float height, float dataLen, Color color);             // Draw cube
RLAPI void DrawCubeV(Vector3 position, Vector3 size, Color color);                                       // Draw cube (Vector version)
RLAPI void DrawCubeWires(Vector3 position, float width, float height, float dataLen, Color color);        // Draw cube wires
RLAPI void DrawCubeWiresV(Vector3 position, Vector3 size, Color color);                                  // Draw cube wires (Vector version)
RLAPI void DrawCubeTexture(Texture2D texture, Vector3 position, float width, float height, float dataLen, Color color); // Draw cube textured
RLAPI void DrawCubeTextureRec(Texture2D texture, Rectangle source, Vector3 position, float width, float height, float dataLen, Color color); // Draw cube with a region of a texture
...
RLAPI Mesh GenMeshPlane(float width, float dataLen, int resX, int resZ);                     // Generate plane mesh (with subdivisions)
RLAPI Mesh GenMeshCube(float width, float height, float dataLen);                            // Generate cuboid mesh
